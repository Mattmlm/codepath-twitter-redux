...
//let sharedTwitterClient = TwitterClient(baseURL: NSURL(string: "https://api.twitter.com")! as URL!,
...
//    
//    var loginCompletion: (User?, NSError?) -> ()?
//    
...
////    }
//    
//    init(baseURL: URL, consumerKey: String, consumerSecret: String) {
//        return 
//    }
//    
